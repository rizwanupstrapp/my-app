<template>
  <div class="flex">
    <div class="w-96 bg-gray-700 fixed h-screen top-0 left-0">
      <SidebarComponent />
    </div>
            ...
            <div class="flex items-center justify-between">
              <div class="w-1/2 relative">
                ...
                <transition name="slide">
                  <div
                    class="mt-4 w-max absolute top-12 z-[111] shadow-xl gap-6 bg-white"
                    v-if="expanded"
                  >
          ...
          <thead>
            <tr>
              ...
              <th
                ...
                "
                :key="i"
                v-for="(selectedTableField, i) in selectedTableFields"
              >
          ...
          <tbody class="bg-white">
            <tr :key="i" v-for="(item, i) in getData">
              ...
              <td
                ...
                :key="j"
                v-for="(selectedItemField, j) in selectedTableFields"
              >
                <!-- selectedTableFields working-->
                <!-- displayTableFieldOnSelect -->
